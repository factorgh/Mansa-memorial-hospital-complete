    ...
    return (
        <div className="w-full px-8 py-8">
            <div className=" w-full h-full bg-white rounded-md p-10 flex flex-col justify-center items-center ">
                ...
                <form action="" className="flex flex-col w-full" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex gap-4">
                        <Form title="Purpose of visit">
                            ...
                            >
                                ...
                                <option value="communtiy">Community health</option>
                                <option value="antenatal">Midwifery</option>
                            </select>
                        </Form>
