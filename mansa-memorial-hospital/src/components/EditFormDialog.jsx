...
export default function AlertDialogSlide({ icon }) {
    ...
    const onSubmit = (data) => {
        console.log(data);
        if (data.patient === "" || data.testName === "other" || data.fileNumber === 0) return;
    ...
    return (
        <React.Fragment>
            <Button variant="contained" onClick={handleClickOpen}>
                <h3 className="flex gap-2 items-center justify-center">{icon}</h3>
            </Button>
            <Dialog
                open={open}
